  ...
  const renderItem = ({ item: event }: { item: (typeof events)[number] }) => {
    ...
    return (
      ...
      >
        ...
        <View style={[styles.cardAccent, expired ? styles.cardAccentExpired : styles.cardAccentActive]} />
...
const styles = StyleSheet.create({
  ...
  signOutBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, backgroundColor: '#f3f4f6' },
  ...
  emptySubtitle: { fontSize: 14, color: '#9ca3af', marginTop: 6, textAlign: 'center', maxWidth: 260 },
